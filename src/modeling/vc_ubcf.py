...
evaluation_func.evaluate(auc_test, auc_pred, outdir='drug_response/model_performance/vc_ubcf_all_cpd_balanced')
...
evaluation_func.evaluate(auc_test, auc_pred, outdir='drug_response/model_performance/vc_ubcf_fda_cpd_balanced')
