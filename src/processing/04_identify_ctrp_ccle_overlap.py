...
ctrp_meta = pd.read_csv("/projects/b1131/saya/drug_response/ctrp/v20.meta.per_cell_line.txt", sep="\t")
ccle_anno = pd.read_csv("/projects/b1131/saya/drug_response/ccle/Cell_lines_annotations_20181226.txt", sep="\t")
